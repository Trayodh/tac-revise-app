...
EXPANDED_NOTES_DATA["econ-poverty-employment"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["five-year-plans"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["external-sector-institutions"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["physics-heat"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["physics-electricity-magnetism"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["physics-nuclear-basics"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["physics-units-everyday"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["chemistry-everyday-fertilisers"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["environmental-chemistry"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["immunity-vaccines"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["biology-ecology-basics"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["defence-organisations-weapons"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
...
EXPANDED_NOTES_DATA["ca-science-tech-space"] = `### 📝 Exam Question Analysis (UPSC Local Engine)
