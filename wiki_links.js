...
// Polity & Institutions
  ...
  "Article 48A",
  "Articles",
  "Artificial Intelligence (AI) in Command & Control",
  "Ashoka Chakra",
  "Ashoka Chakra",
  "Asian Elephant",
  "Assertive Sentence",
  ...
  "Avogadro's number",
  "Ayodhya Judgment",
  "Ayodhya Judgment – M Siddiq v. Union of India",
  "Ayushman Bharat – PMJAY",
  "BCG",
  "BRICS",
  "BRICS Summit – 2022 (India)",
  "Balance of Payments",
  ...
  "Blaise Pascal",
  "Blitzkrieg",
  "Bombay High Court – BCCI vs. Cricket Players’ Association",
  ...
  "Conservation of Marine Turtles (CMT) Programme",
  ...
  "Cyber Security Framework for Critical Information Infrastructure (CIS‑CII) 2022",
  "Cycadeoidea",
  "Cycas revoluta",
  "Cylinder",
  "Cyperaceae",
  ...
  "DPT",
  "DRDO",
  "DRDO Solid Propellant Laboratory",
  "December",
  "Deep Space Network",
  "Defence Procurement Procedure (DPP) 2020",
  "Defence Research and Development Organisation (DRDO)",
  "Defence Services Selection Board (DSSB) Manual",
  "Defence Services Staff College",
  "Defence Services Staff College (DSSC), Wellington",
  "Defense Research & Development Organisation (DRDO) – Biological Warfare Countermeasure Programme",
  "Defense Research and Development Organisation (DRDO)",
  "Degree",
  "Delhi",
  "Delhi High Court",
  "Delhi High Court – Right to Health in COVID‑19 Pandemic",
  "Denmark",
  "Denotative Meaning",
  "Department of Biotechnology (DBT) Annual Report 2022‑23",
  ...
  "Discount",
  "Doctrine of Lapse",
  "Doctrine of “Integrated Air Defence System (IADS)",
  "Doppler effect",
  ...
  "Euler's line",
  "Europe",
  "European Space Agency (ESA) – LISA Pathfinder Collaboration",
  "European Union",
  "Exclamation Mark",
  ...
  "Gaganyaan Programme",
  "Galena",
  "Gallantry Awards Act, 1950",
  "Game of Ur",
  "Ganga",
  "Gauss's law for magnetism",
  "General Agreement on Tariffs and Trade",
  "General Bipin Rawat",
  "General Sir Sam Manekshaw",
  ...
  "Grey Wolf",
  "Group of Seven (G7)",
  "Gujarat High Court – Gujarat Renewable Energy Policy Review",
  "Gulf War",
  "Gustav Fechner",
  "HADR Operations",
  "HAL Tejas Mk‑II",
  ...
  "Indian Air Force",
  "Indian Air Force – Training Manual on Map Reading",
  "Indian Armed Forces",
  "Indian Army",
  "Indian Army Corps of Engineers",
  "Indian Army Modernisation",
  "Indian Constitution",
  "Indian Council for Forestry Research and Education (ICFRE) v. Union of India (2021)",
  "Indian Institute of Science (IISc)",
  "Indian National Calendar",
  "Indian National Space Promotion and Authorisation Centre (IN-SPACe)",
  "Indian Navy",
  "Indian Ocean Rim Association (IORA)",
  "Indian Ordnance Factories (IOF)",
  "Indian Penal Code (IPC) – Sections 124A, 302, 307",
  "Indian Rhinoceros",
  "Indian Space Policy",
  ...
  "India‑Australia Maritime Security Agreement",
  "India‑France Strategic Partnership",
  "India‑Israel Defence Collaboration",
  "India‑Russia Defence Cooperation Agreement (DCA)",
  "India‑UK Trade Agreement",
  "India‑US Defense Trade and Cooperation Agreement (DTCA)",
  "India‑United States 2+2 Dialogue",
  ...
  "Integrated Defence Staff (IDS) Headquarters",
  ...
  "International Telecommunication Union (ITU) – 5G‑Ready Framework",
  ...
  "Joint Exercise “Malabar”",
  "Joint Services Headquarters",
  "Joint Tactical Air Command (JTAC)",
  "Joule",
  ...
  "K9 Vajra Ship‑Mounted Launcher",
  "Kargil Conflict",
  "Kargil War",
  "Karnataka High Court – Cauvery Water Dispute",
  "Kashmir",
  "Kashmir Conflict",
  "Kashmir Valley",
  ...
  "Leonhard Euler",
  "Lieutenant General",
  "Lieutenant General H. N. K. Singh",
  "Linking Verb",
  "Linnaeus",
  "Lise Meitner",
  "Lithium",
  ...
  "Loss",
  "Louis Pasteur",
  "Lt. Colonel S. K. Singh",
  "Lucknow",
  "Lycopodium clavatum",
  "M-16 rifle",
  "M. K. Pandey – Aptitude for NDA & CDS",
  ...
  "Mahadevi Varma",
  "Maharashtra",
  "Maharashtra High Court – Maharashtra Control of Organised Crime Act (MCOCA) Review",
  "Mahatma Gandhi",
  ...
  "Margin",
  "Marie Curie",
  "Maritime Doctrine – “Blue‑Water” strategy",
  "Markup",
  "Mauryan Empire",
  "Max Planck",
  "Max Wertheimer",
  ...
  "NASA",
  "NASA‑ISRO Joint Mission “NISAR”",
  "NATO",
  "NCERT Class XI English – Communicative English",
  "NDA",
  "NDA 2024 Previous Papers",
  "NDA, CDS, AFCAT",
  "NITI Aayog Structure",
  "NITI Aayog’s “India Innovation Index 2023”",
  "Nag Missile",
  "Namami Gange (National Mission for Clean Ganga)",
  "Nanda Devi",
  "National AI Strategy 2022",
  ...
  "National Defence Policy 2019",
  "National Defence University",
  "National Digital Health Mission",
  "National Education Policy 2020",
  "National Environment Policy, 2006",
  "National Film Award",
  "National Financial Reporting Authority Act 2015",
  "National Food Security Act",
  "National Ganga River Basin Authority (NGRBA) – Riverine Biodiversity Initiative",
  "National Green Tribunal Act",
  "National Health Policy 2017",
  "National Hydrogen Energy Mission",
  "National Innovation Award",
  "National Livestock Mission",
  "National Mission for Clean Air (NMCA) – Delhi",
  "National Programme on Precision Weapon Systems",
  "National Quantum Mission",
  "National Remote Sensing Centre (NRSC)",
  "National Science and Technology Policy (NSTP) 2023",
  "National Science and Technology Policy 2023",
  "National Security Act, 1980",
  "National Security Council (NSC)",
  "National Security Strategy (NSS) 2023",
  "National Solar Mission",
  "National Solar Mission (JNNSM)",
  "National Sports Policy",
  "National Thermal Power Corporation (NTPC)",
  "National Tiger Conservation Authority (NTCA)",
  "Naval Icebreaker Programme",
  "Navtej Singh Johar",
  ...
  "Object",
  "October",
  "Office of the Chief of Defence Staff (OCDS)",
  "Offset Clause",
  "Ogive",
  "Ohm",
  "Ohm's Law",
  ...
  "Operation Rahat",
  "Operation Rakshak (1999‑present)",
  "Operation Rhino",
  ...
  "Padma Awards Act, 1954",
  "Padma Bhushan",
  "Padma Shri",
  "Padma Shri (Arts)",
  "Padma Shri (Science & Engineering)",
  "Padma Vibhushan",
  "Pakistan",
  "Para Jumbles",
  "Parallelism",
  ...
  "Pune",
  "Punjab",
  "Punjab & Haryana High Court – Jalandhar Land Acquisition Case",
  "Pyramid",
  "Pyromania",
  "Pythagoras",
  ...
  "Quad Quadri‑Space Initiative",
  "Quadrants",
  "Quadrilateral Security Dialogue (Quad)",
  "Quantum Communication Links",
  "Quantum‑Enabled Secure Communications Act, 2024",
  "Question Mark",
  "Quotation Marks",
  "R. K. Narayan",
  "R.S. Aggarwal",
  ...
  "Siachen Glacier",
  "Sikkim",
  "Sikkim State Climate Action Plan",
  "Silence",
  "Silver",
  "Simla Agreement",
  "Simple Future",
  ...
  "Space Cooperation Treaty – India‑France",
  "Space Sector Reforms in India",
  "Space-Based Solar Power Initiative",
  "SpaceX’s Starlink Programme – India Pilot Phase",
  "Sparrow",
  ...
  "T.N. Godavarman Thirumulpad v. Union of India (2015)",
  "TE‑90",
  "Table",
  "Taiwan",
  "Taiwan Strait",
  ...
  "Tangent",
  "Tangent function",
  "Telecommunications (Re-organisation) Act 1994",
  "Telstar 1",
  "Tense",
  "Tense Consistency",
  "Tenses",
  ...
  "UN Convention on the Prohibition of Military Use of Space (Draft)",
  "UN General Assembly (UNGA)",
  "UN Sustainable Development Goals (SDGs) – Goal 15",
  ...
  "Wing",
  "Word Families",
  "World Bank “India Digital Economy Report 2023”",
  ...
  "Yudh Abhyas",
  "Zamia integrifolia",
  "Zero Budget Natural Farming (ZBNF) Initiative",
  "Zinc",
  "Zoology",
  "Zorawar Light Tank",
  "adjective",
