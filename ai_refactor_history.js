...
async function runBatch() {
  ...
  const historyFilePath = 'notes_extra_history.js';
...
\`\`\`
  ...
  fs.writeFileSync('notes_extra_history.js', newFileOutput);
  console.log("Successfully updated notes_extra_history.js");
  
  fs.writeFileSync('extracted_history_mcqs.json', JSON.stringify(allExtractedMCQs, null, 2));
  console.log(`Saved ${allExtractedMCQs.length} total extracted MCQs to extracted_history_mcqs.json`);
}
