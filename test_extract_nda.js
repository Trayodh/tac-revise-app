...
async function main() {
    ...
    for (const file of files) {
        ...
        for (let j = 0; j < chunks.length; j++) {
            ...
            console.log(`Test run: extracted ${parsedQs.length} questions from 1 chunk. Breaking.`);
            break;
        }
        
        console.log(`Finished processing test file ${file}`);
        break;
    }

    console.log(`\nTest extraction completely finished! Total questions extracted: ${extractedData.length}`);
}
