...
<div class="msc-checkpoint" style="margin-top: 24px;">
  ...
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Magadha's dominance was driven by a trifecta of advantages: fertile alluvial soil, abundant iron deposits in the Chota Nagpur plateau, and a strategic location protected by the Vindhya and Satpura ranges.</li>
    <li style="margin-bottom: 8px;">The Haryanka dynasty (Bimbisara and Ajatashatru) laid the foundation for the first significant territorial state in India, transitioning from a tribal republic to a centralized monarchy.</li>
    <li style="margin-bottom: 8px;">Pataliputra (modern Patna) served as the administrative capital, while Rajgir (Rajagriha) was the religious and early political center, both crucial for understanding the geography of the Mahajanapadas.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  ...
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Magadha's rise is fundamentally linked to the Iron Age (c. 1000 BCE), where access to iron allowed for the clearing of dense forests and the cultivation of fertile land, supporting a larger population and standing army.</li>
    <li style="margin-bottom: 8px;">The transition from the Vedic period's tribal assemblies (Sanghas) to the Mahajanapada system marked a shift towards urbanization and centralized authority, with Magadha being the pioneer in this political evolution.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Quick Summary</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Ancient Indian culture is defined by the evolution of the Varna system, the codification of Sanskrit literature, and the rise of heterodox religions like Buddhism and Jainism.</li>
    <li style="margin-bottom: 8px;">The period witnessed monumental architectural shifts from rock-cut caves to structural temples, alongside a golden age of science and mathematics during the Gupta era (e.g., Aryabhata, Sushruta).</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Background Context</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">The cultural landscape was shaped by the synthesis of Vedic traditions with the urbanization and trade networks of the Mauryan and Gupta empires, leading to a standardized Sanskritic culture.</li>
    <li style="margin-bottom: 8px;">The rise of Buddhism and Jainism provided a philosophical counter-narrative to Brahmanical orthodoxy, influencing art, language (Pali/Prakrit), and social mobility.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Exam Relevance</div>
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Quick Summary</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">The British transitioned from commercial traders to political rulers via the dual victories at Plassey (1757) and Buxar (1764), establishing the foundation of the British Raj.</li>
    <li style="margin-bottom: 8px;">Lord Wellesley’s Subsidiary Alliance and Lord Dalhousie’s Doctrine of Lapse were the primary diplomatic and legal instruments used to annex Indian princely states without direct large-scale warfare.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Background Context</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">The expansion was driven by the need for secure trading posts and the strategic advantage gained after the Mughal Empire’s fragmentation, allowing the Company to exploit political rivalries among Indian states.</li>
    <li style="margin-bottom: 8px;">The shift from the 'Company Raj' to direct Crown rule was precipitated by the failure of the 1857 Revolt, leading to the Government of India Act 1858.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Exam Relevance</div>
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Quick Summary</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Modern History is the highest-weightage section, with a specific emphasis on the Freedom Struggle, Gandhian Era, and legislative Acts/Reforms.</li>
    <li style="margin-bottom: 8px;">Ancient History questions predominantly target Buddhism/Jainism, Indus Valley Civilization, and Gupta Administration.</li>
    <li style="margin-bottom: 8px;">Medieval History focuses heavily on the Delhi Sultanate and Mughal administrative systems and architecture.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Background Context</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">The distribution of PYQs reflects the NCERT syllabus weightage, where Modern History constitutes approximately 50-60% of the History section in Prelims, followed by Medieval and Ancient History.</li>
    <li style="margin-bottom: 8px;">The focus on specific sub-topics (like Gandhian Era or Mughal Administration) indicates a shift from broad chronological knowledge to thematic and administrative depth.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Exam Relevance</div>
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Quick Summary</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Economic measures are statistical tools used to quantify economic performance, including inflation indices (CPI, WPI), growth metrics (GDP, GNP), and distribution indicators (Gini Coefficient).</li>
    <li style="margin-bottom: 8px;">These metrics serve as the primary basis for monetary policy decisions by the RBI and fiscal policy formulation by the Government of India.</li>
    <li style="margin-bottom: 8px;">Understanding the distinction between nominal and real values, as well as the specific baskets of goods used in different indices, is crucial for accurate economic analysis.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Background Context</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">The concept of national income accounting was formalized in the 20th century to provide a standardized method for measuring economic output, with the System of National Accounts (SNA) serving as the international framework adopted by India.</li>
    <li style="margin-bottom: 8px;">In India, the shift from using WPI to CPI as the primary inflation indicator reflects a modernization of monetary policy to better reflect the cost of living for the average citizen.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Exam Relevance</div>
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Quick Summary</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Figure Coding involves identifying the logical relationship between a source figure and its coded counterpart (e.g., rotation, inversion, or element substitution) and applying the same rule to a new figure.</li>
    <li style="margin-bottom: 8px;">Success in this topic relies on systematic observation of directional changes, positional shifts, and attribute modifications rather than guesswork.</li>
    <li style="margin-bottom: 8px;">Rigorous practice with at least 50 Previous Year Questions (PYQs) under timed conditions is essential to build pattern recognition speed and accuracy.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
...
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Background Context</div>
  <ul style="padding-left: 20px; font-size: 0.95rem; color: var(--text-secondary);">
    <li style="margin-bottom: 8px;">Figure coding is a fundamental component of non-verbal reasoning, testing abstract thinking and spatial intelligence, which are critical attributes for defense services and administrative roles.</li>
    <li style="margin-bottom: 8px;">The logical basis is derived from set theory and transformational geometry, where a function maps one set of visual elements to another.</li>
  </ul>
</div>
<div class="msc-checkpoint" style="margin-top: 24px;">
  <div class="msc-title">dY"s Exam Relevance</div>
